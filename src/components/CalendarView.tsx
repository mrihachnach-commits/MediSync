                    ...
                    <tr className="bg-amber-950/10 hover:bg-amber-950/20 transition-colors">
                      ...
                      {weekDays.map(({ dayOfWeek, isoStr }) => {
                        ...
                        return (
                          <td
                            key={dayOfWeek}
                            className="p-2 border-r border-slate-800/80 last:border-r-0 align-top min-w-[120px]"
                          >
                            <div className="space-y-2 min-h-[140px]">
                              {daytimeEvts.length === 0 ? (
                                <div className="h-full min-h-[120px] flex items-center justify-center text-[10px] text-slate-600 border border-dashed border-slate-800/60 rounded-xl p-2 text-center">
                                  Trống ca sáng / chiều
                                </div>
                              ) : (
                  ...
                  >
                    ...
                    <div className="space-y-3 flex-1 overflow-y-auto pr-0.5 scrollbar-thin">
                      <div className="space-y-1.5">
                        <div className="px-2 py-1 rounded-lg bg-amber-950/40 border border-amber-800/40 flex items-center justify-between text-[11px] font-semibold text-amber-300">
                        ...
                        {daytimeEvts.length === 0 ? (
                          <div className="py-3 text-center text-[10px] text-slate-600 border border-dashed border-slate-800/60 rounded-xl">
                            Trống ca ngày
                          </div>
                        ) : (
                          daytimeEvts.map((evt) => renderEventCard(evt))
                      ...
                      <div className="space-y-1.5">
                        <div className="px-2 py-1 rounded-lg bg-indigo-950/50 border border-indigo-800/40 flex items-center justify-between text-[11px] font-semibold text-indigo-300">
                          <span className="flex items-center gap-1">
                    ...
                    daySourceEvts.forEach((se) => {
                      ...
                      if (!isAlreadyOnTarget) {
                        newDraftItems.push({
                          ...
                          syncedGoogle: se.syncedGoogle,
                          syncedOutlook: se.syncedOutlook,
                          completed: false,
                        });
                      }
                    });
